...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer** One column is date, one is for press releases. They are both character formats. 
...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; what other information about these releases might you want to add? **Answer** I'd maybe want to add day of the week or if possible, a time of day. Therefore I could predict when releases would most likely be coming so I could be prepared. 
...
tags there are in the HTML source? **Answer** There are 122 tags
...
tags. Describe the output: **Answer** An HTML list of a number of tags. 
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer** A list of all articles and the date. However, the date and article are in the same column
