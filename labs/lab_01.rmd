...
**A1**  Engineering and cooperative education. I am surprised it is engineering. I figured first-year classes, considering how large a freshman class is and the fact that those classes would be larger. 
...
**Q3** Count the number of courses for each instructor and department. Which instructor has taught the most? **A3** Keith Yearwood, 61
...
**Q4** Given the results for Q3, what would have made it easier to find the answer? You don't have to know *how* to accomplish this; I want you to describe in words what would make the answer easier to see. How confident are you that the answer you got is the right one, and why? **A4** It would have made it easier if I could eliminate the N/A's, so the correct answer showed up first. I am pretty confident the answer is the right one, however I wouldn't be shocked if there was one buried. 
