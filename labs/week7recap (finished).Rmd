...
**A1:** This dataset contains information on earthquakes, quarry blasts, ice quakes and other types of geological events happening around the world. 
...
**A2:**There are 9,774 records in this dataset. They are describing different geological events, such as earthquakes. From this we can gather the magnitude, the depth, the location and also potential margin of error in the data. 
------------------------------------------------------------------------
...
**A3:**
The depth for the deepest 669.9820 and magnitude of 4.20. 
------------------------------------------------------------------------
...
**A4:** There are 13 that fit this criteria.
...
**A5:** There are six that fit that criteria. 
...
**A6:** There are 7,446 answers for this dataset. 
...
**A7:** There are 3,346 per my data. 
...
**A8:**
Earthquake and quarry blasts are the first two most common types of tremors in this set. 
------------------------------------------------------------------------
...
**A9:**
I think its odd that the mean is so high especially with the amount of mini earthquakes there are. 
------------------------------------------------------------------------
...
```{r}
earthquake_final<-earthquake_hours %>% 
...
**A12**: The hour with the most is 0 and the one with the least is the 23rd. 

------------------------------------------------------------------------

How many serious earthquakes have there been?
...
```{r}
earthquake_final %>% 
  filter(str_detect(concern_level,"serious")) %>% 
  summarise(count = n())
