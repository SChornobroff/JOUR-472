...
**Answer** Copy the url of the graphic you published here. It will begin with <https://datawrapper.dwcdn.net/>. Don't copy the browser's current url. https://www.datawrapper.de/_/9XIJR/
...
After doing that, the map shrinks from a map of the United States to a map of Maryland. 
...
With this, I know see results by county labeled with the county name accompanied by the percentage number. 
...
**Task** Click the "Proceed" button until you get to the "Publish & Embed" tab, then click "Publish Now". Copy the published URL (like you did for the chart above) and paste it below. **Answer** Put the URL of your map here. https://www.datawrapper.de/_/QSv0y/
