...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer** Nevada has the largest percentage growth
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer** Howard County, Maryland 
...
Is the difference between Calvert and Montgomery significant? **Answer** The difference between Calvert and Montgomery is not significant, in fact the two overlap. 

Is the difference between Howard and everyone else significant? **Answer* I'd say the difference between Howard and others is significant. It's lower end of the margin of error is still signifcantly farther than Calvert's highest potential median income. 
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer**  There are 50 schools with more than 60% who graduated and 76 schools with less than 40%
