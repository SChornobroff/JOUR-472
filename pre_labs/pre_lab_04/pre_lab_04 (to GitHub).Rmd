...
It removed a lot of punctuation, linke the period in INC and made a number of grantees all capitalized. 
```{r}
...
**Task** Run the following code to group by grantee_clean and Grantee, then filter for recipients that start with W. Name three changes the refinr function made in the first 30 results. **Answer** It backspaced a comma closer in Waldorf Prosperity, LLC, made Washington Adventist University lowercase
