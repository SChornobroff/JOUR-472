...
In the space below, write the data type for the "id" column and the "seats" column (it's in light gray, offset by \< \>). **Answer** It's a character
...
In the space below, write the name of the cousw from the first row of the "title" column. **Answer** Directed Research
...
**Answer** The first line of code is giving the term and the second is giving the amount of seats.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** We did it in descending order
...
**Answer** It was arranged by department and by term due to the last line of code changing.  
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** Compared to the previous one, this is set in descenting order of classes counted and total seats. 
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer** In this dataset we added in mean and median. This added more rows and extra data. The top terms are mostly Post-2020, showcasing a Post and Pre-Covid difference and the top terms are in the fall. 
...
**Answer** We added minimum and maximum seats, which disqualified 10 classes and this is only showing one term. 
...
1.  What is the difference in mean and median between fall semesters and spring semesters. 

2. Which schools are offering the most large classes?  

3.  For the schools that are offering the least number of classes, how big are there classes? Is it big enough to where there should be multiple sections. 
