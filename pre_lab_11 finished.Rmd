...
**Task** Run the following code and describe the dataframe it outputs. **Answer** A dataframe of press releases from Ben Cardin, organized by date. 
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** The function unique eliminates duplicates of certain words. 
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** A list of individual words 
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer** Nothing crazy, maybe the usage of the word Maryland, but most of these words are normal words used to make up a sentence. 
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer** yes, the word health shows how this can be used to find stories and see what is at the forefront of the senator's media releases. 
...
**Task** Run the following code and describe the results. **Answer** Act, national and health are the top three words. The top three words from 2021, 2022 and 23 are "act", "national" and "health" makes sense considering the timeline of the pandemic. 
...
**Task** Run the following code and describe the results. **Answer** COVID-19 was used in more than 80% of releases, which is a story. 19 pandemic is used in almost 31%, although a number of these likely overlap. 
...
**Task** Run the following code and describe the results. **Answer** When you use just 2022, you see a stark drop in COVID-19 related mentions, however project location is 57%. I'm assuming this is related to the new FBI headquarters in Maryland, however I could be wrong. 
...
**Task** Run the following code and describe the results. **Answer** Human and equal rights are the top-two. Finding a date that started can help coincide what may be the reason and the senator's stance on certain issues, or if there has been a change in stance. 
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** A lot of these words I can see the sentiments being wrong in certain instances. Something like critical is listed as negative. But if the government took a critical step towards combatting the mental health crisis, that would be positive. 
