...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer** It has 4 columns and 3,822 rows. 
...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer** The first step is mutating for their to be a month column, that's a date. The second step is grouping the calls by month and lastly its counting the total calls by month before organizing them in descending order. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A gray nothing 
...
USe + sign instead of %>%  when making a new line in GGPlot

**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a gray bar graph representing the 911 calls data. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It is now in ascending order from least to most calls instead of in chronological order. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It is now in a horizontal instead of vertical few. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** We have added a theme that affects the appearance of it. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** It is in light blue to resemble the economist. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** We flipped the X and the Y axis and changed the titles, as well as added a caption. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A dataset giving the amount of 911 calls for each day. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A hectic line graph of the 911 calls each day. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A slightly less hectic line graph. There's more room to breathe with the lines but the dates are overlapping and still difficult to read. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a line graph, however due to angle adjustments, the outliers stick out more. 
